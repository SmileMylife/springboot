...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.example.springboot.webservice.HelloWorldService {
    ...
    public com.example.springboot.webservice.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.example.springboot.webservice.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.springboot.webservice.HelloWorldSoapBindingStub _stub = new com.example.springboot.webservice.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.springboot.webservice.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.springboot.webservice.HelloWorldSoapBindingStub _stub = new com.example.springboot.webservice.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
